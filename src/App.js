...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className='desc'>Indicazioni per la selezione dei canti:<br/><br/> <li> <strong>Eucarestia</strong>. scegliere canti per: ingresso, pace, pane, vino e finale. Bisogna scegliere i canti contrassegnati con la rispettiva etichetta</li>
        <br/><br/> <li><strong>Parola</strong>. segliere i canti per: ingresso, I lettura, II lettura, III lettura e finale. I canti di ingresso e finale devono essere scelti tra quelli contrassegnati con la rispettiva etichetta, per i canti delle letture, invece, è possibile scegliere tra tutti quelli disponibili</li>
